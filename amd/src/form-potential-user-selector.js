 ...
 *
 * @module     enrol_keyusermanual/form-potential-user-selector
...
define(['jquery', 'core/ajax', 'core/templates', 'core/str'], function($, Ajax, Templates, Str) {
    ...
    return /** @alias module:enrol_keyusermanual/form-potential-user-selector */ {
        ...
        transport: function(selector, query, success, failure) {
            ...
            promise = Ajax.call([{
                methodname: 'enrol_keyusermanual_get_potential_users',
                args: {
                    courseid: courseid,
                    enrolid: enrolid,
                    search: query,
            ...
            promise[0].then(function(results) {
                ...
                if (results.length <= perpage) {
                    ...
                    $.each(results, function(index, user) {
                        ...
                        promises.push(Templates.render('enrol_keyusermanual/form-user-selector-suggestion', ctx));
                    });
