...
$string['enrolusers'] = 'Enrol users (keyuser)';
$string['enroluserscohorts'] = 'Enrol selected users and cohorts (keyuser)';
...
$string['keyusermanual:config'] = 'Configure keyuser manual enrol instances';
$string['keyusermanual:enrol'] = 'Enrol users';
$string['keyusermanual:manage'] = 'Manage user enrolments';
$string['keyusermanual:unenrol'] = 'Unenrol users from the course';
$string['keyusermanual:unenrolself'] = 'Unenrol self from the course';
$string['messageprovider:expiry_notification'] = 'Manual enrolment expiry notifications';
$string['now'] = 'Now';
$string['pluginname'] = 'Manual enrolments (keyuser)';
$string['pluginname_desc'] = 'The keyuser manual enrolments plugin allows users to be enrolled manually via a link in the course administration settings, by a user with appropriate permissions such as a teacher. The plugin should normally be enabled, since certain other enrolment plugins, such as self enrolment, require it.';
...
$string['wsnoinstance'] = 'Keyuser manual enrolment plugin instance doesn\'t exist or is disabled for the course (id = {$a->courseid})';
$string['wsusercannotassign'] = 'You don\'t have the permission to assign this role ({$a->roleid}) to this user ({$a->userid}) in this course ({$a->courseid}).';
$string['manualpluginnotinstalled'] = 'The "Keyuser manual" plugin has not yet been installed';
$string['privacy:metadata'] = 'The Keyuser manual enrolments plugin does not store any personal data.';
