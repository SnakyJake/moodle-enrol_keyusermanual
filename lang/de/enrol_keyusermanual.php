...
$string['enrolusers'] = 'Nutzer/innen einschreiben (Keyuser)';
$string['enroluserscohorts'] = 'Ausgewählte Nutzer/innen und globale Gruppen einschreiben (Keyuser)';
...
$string['keyusermanual:config'] = 'Manuelle Einschreibung (Keyuser) verwalten';
$string['keyusermanual:enrol'] = 'Nutzer/innen einschreiben (Keyuser)';
$string['keyusermanual:manage'] = 'Nutzereinschreibung verwalten';
$string['keyusermanual:unenrol'] = 'Nutzer/innen vom Kurs abmelden';
$string['keyusermanual:unenrolself'] = 'Selbst vom Kurs abmelden';
$string['manualpluginnotinstalled'] = 'Das Plugin \'Manuelle Einschreibung (Keyuser)\' ist nicht installiert.';
$string['messageprovider:expiry_notification'] = 'Systemnachricht beim Ablauf von manuellen Einschreibungen';
$string['now'] = 'Jetzt';
$string['pluginname'] = 'Manuelle Einschreibung (Keyuser)';
$string['pluginname_desc'] = 'Das Plugin \'Manuelle Einschreibung (Keyuser)\' erlaubt es, Nutzer/innen manuell in einen Kurs einzuschreiben. Die Einschreibung in einen Kurs kann von den Trainer/innen (oder jemandem mit passenden Rechten) durchgeführt werden. Das Plugin sollte normalerweise aktiviert sein, da andere Einschreibeplugins (z.B. Selbsteinschreibung) darauf zugreifen.';
...
$string['wscannotenrol'] = 'Die Plugins können Nutzer/innen nicht manuell in den Kurs \'{$a->courseid}\' einschreiben
 ';
$string['wsnoinstance'] = 'Das Plugin \'Manuelle Einschreibung (Keyuser)\' ist nicht vorhanden oder wurde für den Kurs \'{$a->courseid}\' nicht aktiviert';
