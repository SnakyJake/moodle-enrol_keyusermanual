...
$capabilities = array(
    ...
    'enrol/keyusermanual:config' => array(
        'captype' => 'write',
    ...
    /* Enrol anybody. */
    'enrol/keyusermanual:enrol' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_COURSE,
        'archetypes' => array(
            'manager' => CAP_ALLOW,
    ...
    'enrol/keyusermanual:manage' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_COURSE,
        'archetypes' => array(
            'manager' => CAP_ALLOW,
    ...
    'enrol/keyusermanual:unenrol' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_COURSE,
    ),

    /* Unenrol self - watch out for data loss. */
    'enrol/keyusermanual:unenrolself' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_COURSE,
        'archetypes' => array(
        )
