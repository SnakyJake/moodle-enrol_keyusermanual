...
class enrol_keyusermanual_plugin extends enrol_plugin {
    ...
    public function get_manual_enrol_link($instance) {
        ...
        if (!has_capability('enrol/keyusermanual:enrol', $context)) {
            // Note: manage capability not used here because it is used for editing
            // of existing enrolments which is not possible here.
            return NULL;
        }

        return new moodle_url('/enrol/keyusermanual/manage.php', array('enrolid'=>$instance->id, 'id'=>$instance->courseid));
    }
    ...
    public function can_add_instance($courseid) {
        ...
        if (!has_capability('moodle/course:enrolconfig', $context) or !has_capability('enrol/keyusermanual:config', $context)) {
            return false;
        }

        if ($DB->record_exists('enrol', array('courseid'=>$courseid, 'enrol'=>'keyusermanual'))) {
    ...
    public function get_action_icons(stdClass $instance) {
        ...
        $icons = array();
        if (has_capability('enrol/keyusermanual:enrol', $context) or has_capability('enrol/keyusermanual:unenrol', $context)) {
            $managelink = new moodle_url("/enrol/keyusermanual/manage.php", array('enrolid'=>$instance->id));
            $icons[] = $OUTPUT->action_icon($managelink, new pix_icon('t/enrolusers', get_string('enrolusers', 'enrol_keyusermanual'), 'core', array('class'=>'iconsmall')));
        }
    ...
    public function add_instance($course, array $fields = NULL) {
        ...
        if ($DB->record_exists('enrol', array('courseid'=>$course->id, 'enrol'=>'keyusermanual'))) {
    ...
    public function update_instance($instance, $data) {
        ...
        if ($instances = $DB->get_records('enrol', array('courseid' => $instance->courseid, 'enrol' => 'keyusermanual'), 'id ASC')) {
    ...
    public function get_manual_enrol_button(course_enrolment_manager $manager) {
        ...
        foreach ($manager->get_enrolment_instances() as $tempinstance) {
            if ($tempinstance->enrol == 'keyusermanual') {
                if ($instance === null) {
        ...
        $button = new enrol_user_button($link, get_string('enrolusers', 'enrol_keyusermanual'), 'get');
        $button->class .= ' enrol_keyusermanual_plugin';
        ...
        if (!$called) {
            ...
            $PAGE->requires->js_call_amd('enrol_keyusermanual/quickenrolment', 'init', array($arguments));
        }
    ...
    public function sync(progress_trace $trace, $courseid = null) {
        ...
        $trace->output('Verifying keyuser manual enrolment expiration...');
        ...
        if ($action == ENROL_EXT_REMOVED_UNENROL) {
            ...
            $sql = "SELECT ue.*, e.courseid, c.id AS contextid
                      ...
                      JOIN {enrol} e ON (e.id = ue.enrolid AND e.enrol = 'keyusermanual')
     ...
     * as defined by sort_by_roleassignment_authority() having 'enrol/keyusermanual:manage'
     * capability.
     *
    ...
    protected function get_enroller($instanceid) {
        ...
        if ($users = get_enrolled_users($context, 'enrol/keyusermanual:manage')) {
    ...
    public function get_bulk_operations(course_enrolment_manager $manager) {
        ...
        if (has_capability("enrol/keyusermanual:manage", $context)) {
            $bulkoperations['editselectedusers'] = new enrol_keyusermanual_editselectedusers_operation($manager, $this);
        }
        if (has_capability("enrol/keyusermanual:unenrol", $context)) {
            $bulkoperations['deleteselectedusers'] = new enrol_keyusermanual_deleteselectedusers_operation($manager, $this);
        }
    ...
    public function restore_instance(restore_enrolments_structure_step $step, stdClass $data, $course, $oldid) {
        ...
        if ($instances = $DB->get_records('enrol', array('courseid'=>$data->courseid, 'enrol'=>'keyusermanual'), 'id')) {
    ...
    public function can_delete_instance($instance) {
        $context = context_course::instance($instance->courseid);
        return has_capability('enrol/keyusermanual:config', $context);
    }
    ...
    public function edit_instance_form($instance, MoodleQuickForm $mform, $context) {
        ...
        $mform->addElement('select', 'status', get_string('status', 'enrol_keyusermanual'), $options);
        $mform->addHelpButton('status', 'status', 'enrol_keyusermanual');
        ...
        $mform->addElement('duration', 'enrolperiod', get_string('defaultperiod', 'enrol_keyusermanual'), $options);
        $mform->setDefault('enrolperiod', $this->get_config('enrolperiod'));
        $mform->addHelpButton('enrolperiod', 'defaultperiod', 'enrol_keyusermanual');
 ...
 * @return string
 */
function enrol_keyusermanual_output_fragment_enrol_users_form($args) {
    $args = (object) $args;
    $context = $args->context;
    $o = '';

    require_capability('enrol/keyusermanual:enrol', $context);
    $mform = new enrol_keyusermanual_enrol_users_form(null, $args);
